...
class SOFollower(Robot):
    ...
    def calibrate(self) -> None:
        ...
        # Single-turn angle feedback (STS3215 Phase bit) must be set before range recording so
        # wrist_roll positions stay in [0, 4095] during the sweep (see huggingface/lerobot#3373).
